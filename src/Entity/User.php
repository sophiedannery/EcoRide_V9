...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Trajet::class, mappedBy: 'chauffeurs')]
     ...
     */
    #[ORM\OneToMany(targetEntity: Avis::class, mappedBy: 'validateur')]
    ...
    public function removeTrajet(Trajet $trajet): static
    {
        if ($this->trajets->removeElement($trajet)) {
            // set the owning side to null (unless already changed)
            if ($trajet->getChauffeurs() === $this) {
                $trajet->setChauffeurs(null);
            }
        }
    ...
    public function removeAvi(Avis $avi): static
    {
        if ($this->avis->removeElement($avi)) {
            // set the owning side to null (unless already changed)
            if ($avi->getValidateur() === $this) {
                $avi->setValidateur(null);
            }
        }
